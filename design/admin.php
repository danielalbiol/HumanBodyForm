...
<div id="anatomy-admin">
  <div id="anatomy-header">
    <p class="anatomy-shortcode">Insert this shortcode <input type="text" value="[anatomy_back]" readonly> into any page or post to display the interactive drawing.</p>
    ...
    <div class="anatomy-col-lt">
      ...
      <div class="anatomy-settings">
        ...
        <div class="box-body">
          ...
          <div class="area"><p class="area-name">BACK</p>
          ...
          <div class="area"><p class="area-name">LOIN</p>
          ...
          <div class="area"><p class="area-name">BUTTOCKS</p>
          ...
          <div class="area"><p class="area-name">BACK OF THE HAND [Right]</p>
          ...
          <div class="area"><p class="area-name">BACK OF THE HAND [Left]</p>
          ...
          <div class="area"><p class="area-name">HAMSTRING [Right]</p>
          ...
          <div class="area"><p class="area-name">HAMSTRING [Left]</p>
          ...
          <div class="area"><p class="area-name">BACK OF THE KNEE [Right]</p>
          ...
          <div class="area"><p class="area-name">BACK OF THE KNEE [Left]</p>
          ...
          <div class="area"><p class="area-name">CALF [Right]</p>
          ...
          <div class="area"><p class="area-name">CALF [Left]</p>
          ...
          <div class="area"><p class="area-name">SOLE [Right]</p>
            <span class="chkbx"><input type="checkbox" name="enbl_29" value="1" <?php if ($anatomy['enbl_29'] == '1'){echo " checked";} ?>>&nbsp;Active</span>
            <div class="inner-content">
              <div class="area-url">
                <p class="link"><label>Link</label><input type="text" name="url_29" value="<?php echo $anatomy['url_29']; ?>" /></p>
                <p><label>Target</label>
                  <select name="turl_29">
                    <option value="_self" <?php if($anatomy['turl_29'] == '_self'){echo "selected";} ?>>Same Page</option>
                    <option value="_blank" <?php if($anatomy['turl_29'] == '_blank'){echo "selected";} ?>>New Page</option>
                    <option value="none" <?php if($anatomy['turl_29'] == 'none'){echo "selected";} ?>>None</option>
                  </select>
                </p>
              </div>
              <div class="info"><p><textarea rows="5" name="info_29"><?php echo $anatomy['info_29']; ?></textarea></p></div>
            </div>
          </div>

          <div class="area"><p class="area-name">SOLE [Left]</p>
            <span class="chkbx"><input type="checkbox" name="enbl_30" value="1" <?php if ($anatomy['enbl_30'] == '1'){echo " checked";} ?>>&nbsp;Active</span>
            <div class="inner-content">
              <div class="area-url">
                <p class="link"><label>Link</label><input type="text" name="url_30" value="<?php echo $anatomy['url_30']; ?>" /></p>
                <p><label>Target</label>
                  <select name="turl_30">
                    <option value="_self" <?php if($anatomy['turl_30'] == '_self'){echo "selected";} ?>>Same Page</option>
                    <option value="_blank" <?php if($anatomy['turl_30'] == '_blank'){echo "selected";} ?>>New Page</option>
                    <option value="none" <?php if($anatomy['turl_30'] == 'none'){echo "selected";} ?>>None</option>
                  </select>
                </p>
              </div>
              <div class="info"><p><textarea rows="5" name="info_30"><?php echo $anatomy['info_30']; ?></textarea></p></div>
            </div>
          </div>
